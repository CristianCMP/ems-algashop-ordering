...
class BillingTest {
    ...
    void given_validBillingInfo_whenCreate_shouldCreateSuccessfully() {
        com.algaworks.algashop.ordering.domain.model.order.Billing billing = new com.algaworks.algashop.ordering.domain.model.order.Billing(
                validFullName(),
                validDocument(),
                validPhone(),
                validEmail(),
    ...
    void given_nullFullName_whenCreate_shouldThrowException() {
        Assertions.assertThatExceptionOfType(NullPointerException.class)
                .isThrownBy(() -> new com.algaworks.algashop.ordering.domain.model.order.Billing(
                        null,
                        validDocument(),
                        validPhone(),
                        validEmail(),
